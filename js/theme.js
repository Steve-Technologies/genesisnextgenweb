  ...
  class PluginSectionScroll {
      ...
      if ($(window).width() < 992) {
        ...
        $(window).on(
          ...
          ({ currentSection }) => {
            ...
            if (headerColor === "light" || headerColor === "dark") {
              $("#header .header-nav")
              ...
              $("#header .header-nav")
                .removeClass("header-nav-light-text header-nav-dark-text")
                .addClass("header-nav-" + text_color + "-text");
              $("#header .header-nav-features")
                .removeClass(
                  "header-nav-features-dark header-nav-features-light"
                )
                .addClass("header-nav-features-" + text_color);
              $("#header .header-social-icons")
                .removeClass("social-icons-icon-dark social-icons-icon-light")
                .addClass("social-icons-icon-" + text_color);
            }
    ...
    events() {
      ...
      $(window).on("section.scroll.change.header.color", () => {
        let headerColor = $(".section-wrapper")
          .eq(self.getCurrentIndex())
          .find(".section-scroll")
          .data("section-scroll-header-color");
        let headertColor = headerColor;
        if (headerColor === "grey") headertColor = "light";
        $("#header .header-nav")
          .removeClass("header-nav-light-text header-nav-dark-text")
          .addClass("header-nav-" + headertColor + "-text");
        $("#header .header-nav-features")
          .removeClass("header-nav-features-dark header-nav-features-light")
          .addClass("header-nav-features-" + headertColor);
        $("#header .header-social-icons")
          .removeClass("social-icons-icon-dark social-icons-icon-light")
          .addClass("social-icons-icon-" + headertColor);
